import { responseBookMock, responseBooksMock } from "./responseBook.mock";
import { responseBookMapper, responseBooksMapper } from "./search.mapper";

describe("search service tests", () => {
  test("A correct responseBooksMapper test", () => {
    expect(responseBooksMapper(responseBooksMock)).toStrictEqual({
      kind: "books#volumes",
      totalItems: 1,
      items: [
        {
          ...
          volumeInfo: {
            ...
            imageLinks: {
              smallThumbnail:
                "http://books.google.com/books/content?id=yodhDwAAQBAJ&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api",
              thumbnail:
                "http://books.google.com/books/content?id=yodhDwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api",
            },
            language: "pt-BR",
            previewLink:
              "http://books.google.com.br/books?id=yodhDwAAQBAJ&printsec=frontcover&dq=Tolkien&hl=&cd=1&source=gbs_api",
            infoLink:
              "https://play.google.com/store/books/details?id=yodhDwAAQBAJ&source=gbs_api",
            canonicalVolumeLink:
              "https://play.google.com/store/books/details?id=yodhDwAAQBAJ",
          },
          saleInfo: {
            country: "BR",
            ...
            buyLink:
              "https://play.google.com/store/books/details?id=yodhDwAAQBAJ&rdid=book-yodhDwAAQBAJ&rdot=1&source=gbs_api",
            offers: [
              {
                finskyOfferType: 1,
                listPrice: {
          ...
          accessInfo: {
            ...
            epub: {
              isAvailable: true,
              acsTokenLink:
                "http://books.google.com.br/books/download/J_R_R_Tolkien_Uma_biografia-sample-epub.acsm?id=yodhDwAAQBAJ&format=epub&output=acs4_fulfillment_token&dl_type=sample&source=gbs_api",
            },
            pdf: {
              isAvailable: false,
            },
            webReaderLink:
              "http://play.google.com/books/reader?id=yodhDwAAQBAJ&hl=&source=gbs_api",
            accessViewStatus: "SAMPLE",
            quoteSharingAllowed: false,
          },
          searchInfo: {
            textSnippet:
              "Humphrey Carpenter recebeu acesso irrestrito a todos os documentos de Tolkien e entrevistou seus amigos e familiares.",
          },
        },
      ],
    });
  ...
  test("A correct responseBookMapper test", () => {
